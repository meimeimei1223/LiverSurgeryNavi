 ...
 *
 * Compiles the upstream Hansen c-cmaes (upstream/src/cmaes.c) with every external
 ...
 *
 * The upstream source under upstream/src/ is byte-identical to upstream; the renaming
